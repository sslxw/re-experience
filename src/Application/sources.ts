const sources: Resource[] = [
    ...
    {
        name: 'bloodHandsTexture',
        type: 'texture',
        path: 'textures/environment/chair_blood_hands.png',
    },
    {
        name: 'decorModel',
        type: 'gltfModel',
    ...
    {
        name: 'umbrellaDecalTexture',
        type: 'texture',
        path: 'textures/decor/umbrella_decal.png',
    },
    {
        name: 'plantShadowPatchTexture',
        type: 'texture',
        path: 'textures/decor/plant_shadow_patch.png',
    },
    {
